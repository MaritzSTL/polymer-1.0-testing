...
* Please skip to the [Mocha Sinon Chai Cheatsheet](https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet") to see examples.
...
| How do I apply argument matching?                                    | [Mocha Sinon Chai Cheatsheet](#https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet")                                                       | [Sinon Argument Matchers](https://sinonjs.org/releases/latest/matchers "Sinon Argument Matchers")
| How do I test an asynchronous method?                                | [Mocha Sinon Chai Cheatsheet](#https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet")                                                       | [Mocha Asynchronous Testing](https://mochajs.org/#asynchronous-code "Mocha Asynchronous Testing")
| How do I test promises?                                              | [Mocha Sinon Chai Cheatsheet](#https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet")                                                       | [Mocha Promise Testing (resolve, reject)](https://sinonjs.org/releases/latest/stubs/#stubresolvesvalue "Mocha Promise (resolve, reject) Testing")
| How do I mock an API call?                                           | [Mocha Sinon Chai Cheatsheet](#https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet")                                                       | [Sinon Request Fakes](https://sinonjs.org/releases/latest/fake-xhr-and-server "Sinon Request Fakes")
| How do I test the order of method calls?                             | [Mocha Sinon Chai Cheatsheet](#https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet")                                                       | [Sinon Assertions (Asserting Call Order)](https://sinonjs.org/releases/latest/assertions/#sinonassertcallorderspy1-spy2- "Sinon Assertions (Asserting Call Order)")
| How do I manipulate a callback function?                             | [Mocha Sinon Chai Cheatsheet](#https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet")                                                       | [Sinon Replacing Callback Functions](https://sinonjs.org/releases/latest/sandbox/#sandboxreplaceobject-property-replacement "Sinon Replacing Callback Functions")
...
| Mocha Sinon Chai Cheatsheet                                          | [Mocha Sinon Chai Cheatsheet](https://github.com/MaritzSTL/sinon-mocha-chai-cheatsheet "Mocha Sinon Chai Cheatsheet")
